...
<script type="text/javascript">
	$(function() {
		...
		var setting = {
			async : {
				enable : true,
				url : '${contextPath}/manager/system/menuwithurlforgroup_search.do',
				autoParam : [ "id=groupId", "isDisabled" ]
			},
			callback:{
				onClick:function(event,treeId,treeNode){
					var url = "${contextPath}/manager/group/list.do?groupId="+treeNode.id;
		...
		function searchGroup() {
			...
			var texturl = "${contextPath}/manager/group/list.do?groupId=-1&searchText="+searchText;
...
<body style="height: 100%;width: 100%">
	...
	<div id="page-wrap" style="height: 100%;width: 80%;">
		<iframe src="${contextPath}/manager/group/list.do" name="grouplist" id="grouplist" frameborder="0" allowTranspancy="true" height="100%;" width="100%"></iframe>
	</div>
</body>
</html>