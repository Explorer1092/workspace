...
<script src="../../resources/dczj/draw/js/turntable.js"></script>
<style type="text/css">
.lottery {
	position: relative;
...
<body>
	<center>
		<input type="hidden" id="formId" value="${dczjid}">
		<!-- <div class="reward_bar">
			<div class="inner">
				<span class="lng_thirdGift" title="欢迎来到抽奖页面，奖品由问卷发布者提供和发放。">欢迎来到抽奖页面，奖品由问卷发布者提供和发放。</span>
			</div>
		</div> -->
		<div class="lottery">
