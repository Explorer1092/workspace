...
<script type="text/javascript">
	function toolbarAction(action) {
		...
		case 'remove':
			...
			break;
		case 'add':
			openDialog('${contextPath}/manager/user/add_show.do?groupId=${groupId}', 550, 560, {
				title : '用户新增'
			});
			break;
		case 'import':
			openDialog('${contextPath}/manager/user/import_show.do', 550, 170, {
				title : '用户导入'
			});
			break;
		case 'export':
			var ids = getCheckedIds();
			iframeSubmit("${contextPath}/manager/user/export.do?ids=" + ids + "&groupId=${groupId}");
			break;
	...
	function edit(iid, name) {
		openDialog('${contextPath}/manager/user/modify_show.do?iid=' + iid, 550, 560, {
			title : '用户编辑'
		});
	}
...
<body>
	<div id="page-title">
		系统管理 / <span id="page-location">用户管理</span>
	</div>
	<div id="page-content">
