...
<script type="text/javascript">
	$(function() {
		...
		var setting = {
			...
			async : {
				enable : true,
				url : '${contextPath}/manager/menu/menuforwebsearch.do',
...
// 		treeObj.expandAll(true);
		...
		$("#oprform").validity(function(){
			$('#menuIds').assert(function(){
				...
				$('#menuIds').val(menuIds);
				getParentWindow().document.getElementById('rangeWebIds').value = menuIds;
				getParentWindow().document.getElementById('rangeWebNames').value = menuNames;
				return true;
			}, '请选择网站');
		},{
